...
public class ModPlacedFeatures {
    ...
    public static final ResourceKey<PlacedFeature> TOADSTOOL_SPROUTS = registerKey("toadstool_sprouts");
    public static final ResourceKey<PlacedFeature> TOADSTOOL_SPROUTS_COMMON = registerKey("toadstool_sprouts_common");
    public static final ResourceKey<PlacedFeature> GRASS_FOSSIL_FALLS = registerKey("grass_fossil_falls");
    ...
    public static final ResourceKey<PlacedFeature> ORE_FOSSIL_STONE = registerKey("ore_fossil_stone");
    ...
    public static final ResourceKey<PlacedFeature> BONE_MEAL_VEGETATION = registerKey("bone_meal_vegetation");
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context) {
        ...
        register(context, TOADSTOOL_SPROUTS, configuredFeatures.getOrThrow(ModConfiguredFeatures.PATCH_TOADSTOOL_SPROUTS), ImmutableList.of(RarityFilter.onAverageOnceEvery(3), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
        register(context, TOADSTOOL_SPROUTS_COMMON, configuredFeatures.getOrThrow(ModConfiguredFeatures.PATCH_TOADSTOOL_SPROUTS), ImmutableList.of(CountPlacement.of(30), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
        register(context, GRASS_FOSSIL_FALLS, configuredFeatures.getOrThrow(VegetationFeatures.PATCH_TAIGA_GRASS), ImmutableList.of(CountPlacement.of(4), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()));
        ...
        register(context, SPRING_WATER_EXTRA, configuredFeatures.getOrThrow(ModConfiguredFeatures.SPRING_WATER), ImmutableList.of(CountPlacement.of(200), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.absolute(90), VerticalAnchor.absolute(190)), BiomeFilter.biome()));
        ...
        register(context, ORE_FOSSIL_STONE, configuredFeatures.getOrThrow(ModConfiguredFeatures.ORE_FOSSIL_STONE), ImmutableList.of(CountPlacement.of(8), InSquarePlacement.spread(), HeightRangePlacement.uniform(VerticalAnchor.absolute(63), VerticalAnchor.absolute(190)), BiomeFilter.biome()));
        ...
        register(context, BONE_MEAL_VEGETATION, configuredFeatures.getOrThrow(ModConfiguredFeatures.BONE_MEAL_VEGETATION), ImmutableList.of(PlacementUtils.isEmpty()));
    }
