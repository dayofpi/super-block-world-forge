...
public class ModCreativeTabs {
    ...
    public static final RegistryObject<CreativeModeTab> MAIN = CREATIVE_MODE_TABS.register("main", () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.POWER_STAR.get())).title(Component.translatable("itemGroup.super_block_world")).displayItems((itemDisplayParameters, output) -> {
        ...
        output.accept(ModItems.GRITZY_SAND.get());
        output.accept(ModItems.SUSPICIOUS_GRITZY_SAND.get());
        output.accept(ModItems.GRITZY_SANDSTONE.get());
        output.accept(ModItems.GRITZY_SANDSTONE_STAIRS.get());
        output.accept(ModItems.GRITZY_SANDSTONE_SLAB.get());
        output.accept(ModItems.GRITZY_SANDSTONE_WALL.get());
        output.accept(ModItems.CHISELED_GRITZY_SANDSTONE.get());
        output.accept(ModItems.GRITZY_SANDSTONE_BRICKS.get());
        output.accept(ModItems.GRITZY_SANDSTONE_BRICK_STAIRS.get());
        output.accept(ModItems.GRITZY_SANDSTONE_BRICK_SLAB.get());
        output.accept(ModItems.GRITZY_SANDSTONE_BRICK_WALL.get());
        output.accept(ModItems.GRITZY_SANDSTONE_PILLAR.get());
        output.accept(ModItems.SMOOTH_GRITZY_SANDSTONE.get());
        output.accept(ModItems.SMOOTH_GRITZY_SANDSTONE_STAIRS.get());
        output.accept(ModItems.SMOOTH_GRITZY_SANDSTONE_SLAB.get());
        output.accept(ModItems.CUT_GRITZY_SANDSTONE.get());
        output.accept(ModItems.CUT_GRITZY_SANDSTONE_SLAB.get());
        ...
        output.accept(ModItems.GOLDEN_BRICKS.get());
        output.accept(ModItems.GOLDEN_BRICK_STAIRS.get());
        output.accept(ModItems.GOLDEN_BRICK_SLAB.get());
        output.accept(ModItems.GOLDEN_BRICK_WALL.get());
        output.accept(ModItems.GOLDEN_TILES.get());
        output.accept(ModItems.CRYSTAL_BRICKS.get());
        output.accept(ModItems.CRYSTAL_BRICK_STAIRS.get());
        output.accept(ModItems.CRYSTAL_BRICK_SLAB.get());
        output.accept(ModItems.CRYSTAL_BRICK_WALL.get());
        ...
        output.accept(ModItems.ROYALITE_BLOCK.get());
        output.accept(ModItems.ROYALITE_STAIRS.get());
        output.accept(ModItems.ROYALITE_SLAB.get());
        output.accept(ModItems.ROYALITE_WALL.get());
        output.accept(ModItems.BUDDING_ROYALITE.get());
        output.accept(ModItems.ROYALITE_BRICKS.get());
        output.accept(ModItems.CRACKED_ROYALITE_BRICKS.get());
        output.accept(ModItems.ROYALITE_BRICK_STAIRS.get());
        output.accept(ModItems.ROYALITE_BRICK_SLAB.get());
        output.accept(ModItems.ROYALITE_BRICK_WALL.get());
        output.accept(ModItems.CHISELED_ROYALITE_BRICKS.get());
        output.accept(ModItems.SMOOTH_ROYALITE.get());
        output.accept(ModItems.SMOOTH_ROYALITE_STAIRS.get());
        output.accept(ModItems.SMOOTH_ROYALITE_SLAB.get());
        output.accept(ModItems.SMALL_ROYALITE_BUD.get());
        output.accept(ModItems.MEDIUM_ROYALITE_BUD.get());
        output.accept(ModItems.LARGE_ROYALITE_BUD.get());
        output.accept(ModItems.ROYALITE_CLUSTER.get());
        output.accept(ModItems.PACKED_CLOUD.get());
        output.accept(ModItems.CLOUD_STAIRS.get());
        output.accept(ModItems.CLOUD_SLAB.get());
        output.accept(ModItems.FOSSIL_STONE.get());
        ...
        output.accept(ModItems.ROYALITE_SHARD.get());
