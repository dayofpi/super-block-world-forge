...
public class ModBlockStateProvider extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        simpleBlockWithItem(ModBlocks.GRITZY_SAND);
        simpleBlockWithItem(ModBlocks.GRITZY_SANDSTONE.get(), models().cubeBottomTop(name(ModBlocks.GRITZY_SANDSTONE.get()), blockTexture(ModBlocks.GRITZY_SANDSTONE.get()), extend(blockTexture(ModBlocks.GRITZY_SANDSTONE.get()), "_bottom"), extend(blockTexture(ModBlocks.GRITZY_SANDSTONE.get()), "_top")));
        simpleBlockWithItem(ModBlocks.CHISELED_GRITZY_SANDSTONE.get(), models().cubeBottomTop(name(ModBlocks.CHISELED_GRITZY_SANDSTONE.get()), blockTexture(ModBlocks.CHISELED_GRITZY_SANDSTONE.get()), extend(blockTexture(ModBlocks.GRITZY_SANDSTONE.get()), "_top"), extend(blockTexture(ModBlocks.GRITZY_SANDSTONE.get()), "_top")));
        simpleBlockWithItem(ModBlocks.GRITZY_SANDSTONE_BRICKS);
        simpleBlockWithItem(ModBlocks.SMOOTH_GRITZY_SANDSTONE.get(), models().cubeAll(name(ModBlocks.SMOOTH_GRITZY_SANDSTONE.get()), extend(blockTexture(ModBlocks.GRITZY_SANDSTONE.get()), "_top")));
        simpleBlockWithItem(ModBlocks.CUT_GRITZY_SANDSTONE.get(), models().cubeBottomTop(name(ModBlocks.CUT_GRITZY_SANDSTONE.get()), blockTexture(ModBlocks.CUT_GRITZY_SANDSTONE.get()), extend(blockTexture(ModBlocks.GRITZY_SANDSTONE.get()), "_top"), extend(blockTexture(ModBlocks.GRITZY_SANDSTONE.get()), "_top")));
        ...
        simpleBlockWithItem(ModBlocks.GOLDEN_BRICKS);
        simpleBlockWithItem(ModBlocks.GOLDEN_TILES);
        simpleBlockWithItem(ModBlocks.CRYSTAL_BRICKS);
        ...
        simpleBlockWithItem(ModBlocks.ROYALITE_BLOCK);
        simpleBlockWithItem(ModBlocks.BUDDING_ROYALITE);
        simpleBlockWithItem(ModBlocks.ROYALITE_BRICKS);
        simpleBlockWithItem(ModBlocks.CRACKED_ROYALITE_BRICKS);
        simpleBlockWithItem(ModBlocks.CHISELED_ROYALITE_BRICKS);
        simpleBlockWithItem(ModBlocks.SMOOTH_ROYALITE);
        simpleBlockWithItem(ModBlocks.PACKED_CLOUD);
        simpleBlockWithItem(ModBlocks.FOSSIL_STONE);
        ...
        axisBlock((RotatedPillarBlock) ModBlocks.GRITZY_SANDSTONE_PILLAR.get(), blockTexture(ModBlocks.GRITZY_SANDSTONE_PILLAR.get()));
        axisBlock((RotatedPillarBlock) ModBlocks.HARDSTONE_PILLAR.get(), blockTexture(ModBlocks.HARDSTONE_PILLAR.get()));

        stairsBlock((StairBlock) ModBlocks.GRITZY_SANDSTONE_STAIRS.get(), blockTexture(ModBlocks.GRITZY_SANDSTONE.get()), extend(blockTexture(ModBlocks.GRITZY_SANDSTONE.get()), "_bottom"), extend(blockTexture(ModBlocks.GRITZY_SANDSTONE.get()), "_top"));
        stairsBlock((StairBlock) ModBlocks.GRITZY_SANDSTONE_BRICK_STAIRS.get(), blockTexture(ModBlocks.GRITZY_SANDSTONE_BRICKS.get()));
        stairsBlock((StairBlock) ModBlocks.SMOOTH_GRITZY_SANDSTONE_STAIRS.get(), extend(blockTexture(ModBlocks.GRITZY_SANDSTONE.get()), "_top"));
        ...
        stairsBlock((StairBlock) ModBlocks.GOLDEN_BRICK_STAIRS.get(), blockTexture(ModBlocks.GOLDEN_BRICKS.get()));
        stairsBlock((StairBlock) ModBlocks.CRYSTAL_BRICK_STAIRS.get(), blockTexture(ModBlocks.CRYSTAL_BRICKS.get()));
        ...
        stairsBlock((StairBlock) ModBlocks.ROYALITE_STAIRS.get(), blockTexture(ModBlocks.ROYALITE_BLOCK.get()));
        stairsBlock((StairBlock) ModBlocks.ROYALITE_BRICK_STAIRS.get(), blockTexture(ModBlocks.ROYALITE_BRICKS.get()));
        stairsBlock((StairBlock) ModBlocks.SMOOTH_ROYALITE_STAIRS.get(), blockTexture(ModBlocks.SMOOTH_ROYALITE.get()));
        ...
        slabBlock((SlabBlock) ModBlocks.GRITZY_SANDSTONE_SLAB.get(), blockTexture(ModBlocks.GRITZY_SANDSTONE.get()), blockTexture(ModBlocks.GRITZY_SANDSTONE.get()), extend(blockTexture(ModBlocks.GRITZY_SANDSTONE.get()), "_bottom"), extend(blockTexture(ModBlocks.GRITZY_SANDSTONE.get()), "_top"));
        slabBlock((SlabBlock) ModBlocks.GRITZY_SANDSTONE_BRICK_SLAB.get(), blockTexture(ModBlocks.GRITZY_SANDSTONE_BRICKS.get()), blockTexture(ModBlocks.GRITZY_SANDSTONE_BRICKS.get()));
        slabBlock((SlabBlock) ModBlocks.SMOOTH_GRITZY_SANDSTONE_SLAB.get(), blockTexture(ModBlocks.SMOOTH_GRITZY_SANDSTONE.get()), extend(blockTexture(ModBlocks.GRITZY_SANDSTONE.get()), "_top"));
        slabBlock((SlabBlock) ModBlocks.CUT_GRITZY_SANDSTONE_SLAB.get(), blockTexture(ModBlocks.CUT_GRITZY_SANDSTONE.get()), blockTexture(ModBlocks.CUT_GRITZY_SANDSTONE.get()), extend(blockTexture(ModBlocks.GRITZY_SANDSTONE.get()), "_top"), extend(blockTexture(ModBlocks.GRITZY_SANDSTONE.get()), "_top"));
        ...
        slabBlock((SlabBlock) ModBlocks.GOLDEN_BRICK_SLAB.get(), blockTexture(ModBlocks.GOLDEN_BRICKS.get()), blockTexture(ModBlocks.GOLDEN_BRICKS.get()));
        slabBlock((SlabBlock) ModBlocks.CRYSTAL_BRICK_SLAB.get(), blockTexture(ModBlocks.CRYSTAL_BRICKS.get()), blockTexture(ModBlocks.CRYSTAL_BRICKS.get()));
        ...
        slabBlock((SlabBlock) ModBlocks.ROYALITE_SLAB.get(), blockTexture(ModBlocks.ROYALITE_BLOCK.get()), blockTexture(ModBlocks.ROYALITE_BLOCK.get()));
        slabBlock((SlabBlock) ModBlocks.ROYALITE_BRICK_SLAB.get(), blockTexture(ModBlocks.ROYALITE_BRICKS.get()), blockTexture(ModBlocks.ROYALITE_BRICKS.get()));
        slabBlock((SlabBlock) ModBlocks.SMOOTH_ROYALITE_SLAB.get(), blockTexture(ModBlocks.SMOOTH_ROYALITE.get()), blockTexture(ModBlocks.SMOOTH_ROYALITE.get()));
        ...
        wallBlock((WallBlock) ModBlocks.GRITZY_SANDSTONE_WALL.get(), blockTexture(ModBlocks.GRITZY_SANDSTONE.get()));
        wallBlock((WallBlock) ModBlocks.GRITZY_SANDSTONE_BRICK_WALL.get(), blockTexture(ModBlocks.GRITZY_SANDSTONE_BRICKS.get()));
        ...
        wallBlock((WallBlock) ModBlocks.GOLDEN_BRICK_WALL.get(), blockTexture(ModBlocks.GOLDEN_BRICKS.get()));
        wallBlock((WallBlock) ModBlocks.CRYSTAL_BRICK_WALL.get(), blockTexture(ModBlocks.CRYSTAL_BRICKS.get()));
        ...
        wallBlock((WallBlock) ModBlocks.ROYALITE_WALL.get(), blockTexture(ModBlocks.ROYALITE_BLOCK.get()));
        wallBlock((WallBlock) ModBlocks.ROYALITE_BRICK_WALL.get(), blockTexture(ModBlocks.ROYALITE_BRICKS.get()));
