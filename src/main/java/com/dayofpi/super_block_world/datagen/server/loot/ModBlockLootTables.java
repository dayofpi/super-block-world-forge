...
public class ModBlockLootTables extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        dropSelf(ModBlocks.GRITZY_SAND.get());
        dropSelf(ModBlocks.GRITZY_SANDSTONE.get());
        dropSelf(ModBlocks.GRITZY_SANDSTONE_STAIRS.get());
        slab(ModBlocks.GRITZY_SANDSTONE_SLAB);
        dropSelf(ModBlocks.GRITZY_SANDSTONE_WALL.get());
        dropSelf(ModBlocks.CHISELED_GRITZY_SANDSTONE.get());
        dropSelf(ModBlocks.GRITZY_SANDSTONE_BRICKS.get());
        dropSelf(ModBlocks.GRITZY_SANDSTONE_BRICK_STAIRS.get());
        slab(ModBlocks.GRITZY_SANDSTONE_BRICK_SLAB);
        dropSelf(ModBlocks.GRITZY_SANDSTONE_BRICK_WALL.get());
        dropSelf(ModBlocks.GRITZY_SANDSTONE_PILLAR.get());
        dropSelf(ModBlocks.SMOOTH_GRITZY_SANDSTONE.get());
        dropSelf(ModBlocks.SMOOTH_GRITZY_SANDSTONE_STAIRS.get());
        slab(ModBlocks.SMOOTH_GRITZY_SANDSTONE_SLAB);
        dropSelf(ModBlocks.CUT_GRITZY_SANDSTONE.get());
        slab(ModBlocks.CUT_GRITZY_SANDSTONE_SLAB);
        ...
        slab(ModBlocks.GOLDEN_BRICK_SLAB);
        dropSelf(ModBlocks.GOLDEN_BRICK_WALL.get());
        dropSelf(ModBlocks.GOLDEN_TILES.get());
        dropSelf(ModBlocks.CRYSTAL_BRICKS.get());
        dropSelf(ModBlocks.CRYSTAL_BRICK_STAIRS.get());
        slab(ModBlocks.CRYSTAL_BRICK_SLAB);
        dropSelf(ModBlocks.CRYSTAL_BRICK_WALL.get());
        ...
        dropSelf(ModBlocks.ROYALITE_BLOCK.get());
        dropSelf(ModBlocks.ROYALITE_STAIRS.get());
        slab(ModBlocks.ROYALITE_SLAB);
        dropSelf(ModBlocks.ROYALITE_WALL.get());
        dropSelf(ModBlocks.ROYALITE_BRICKS.get());
        dropSelf(ModBlocks.CRACKED_ROYALITE_BRICKS.get());
        dropSelf(ModBlocks.ROYALITE_BRICK_STAIRS.get());
        slab(ModBlocks.ROYALITE_BRICK_SLAB);
        dropSelf(ModBlocks.ROYALITE_BRICK_WALL.get());
        dropSelf(ModBlocks.CHISELED_ROYALITE_BRICKS.get());
        dropSelf(ModBlocks.SMOOTH_ROYALITE.get());
        dropSelf(ModBlocks.SMOOTH_ROYALITE_STAIRS.get());
        slab(ModBlocks.SMOOTH_ROYALITE_SLAB);
        dropWhenSilkTouch(ModBlocks.SMALL_ROYALITE_BUD.get());
        dropWhenSilkTouch(ModBlocks.MEDIUM_ROYALITE_BUD.get());
        dropWhenSilkTouch(ModBlocks.LARGE_ROYALITE_BUD.get());
        ...
        add(ModBlocks.ROYALITE_CLUSTER.get(), createSilkTouchDispatchTable(ModBlocks.ROYALITE_CLUSTER.get(), LootItem.lootTableItem(ModItems.ROYALITE_SHARD.get()).apply(SetItemCountFunction.setCount(ConstantValue.exactly(4.0F))).apply(ApplyBonusCount.addOreBonusCount(Enchantments.BLOCK_FORTUNE)).when(MatchTool.toolMatches(ItemPredicate.Builder.item().of(ItemTags.CLUSTER_MAX_HARVESTABLES))).otherwise(this.applyExplosionDecay(ModBlocks.ROYALITE_CLUSTER.get(), LootItem.lootTableItem(ModItems.ROYALITE_SHARD.get()).apply(SetItemCountFunction.setCount(ConstantValue.exactly(2.0F)))))));
        add(ModBlocks.FOSSIL_STONE.get(), createSilkTouchDispatchTable(ModBlocks.FOSSIL_STONE.get(), this.applyExplosionCondition(ModItems.FOSSIL_STONE.get(), LootItem.lootTableItem(Items.COAL).when(BonusLevelTableCondition.bonusLevelFlatChance(Enchantments.BLOCK_FORTUNE, 0.1F, 0.14285715F, 0.25F, 1.0F)).otherwise(LootItem.lootTableItem(ModItems.FOSSIL_STONE.get())))));
