...
public class ModBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider pProvider) {
        ...
        tag(BlockTags.DIRT).add(ModBlocks.TOADSTOOL_GRASS.get(), ModBlocks.TOADSTOOL_TURF.get(), ModBlocks.TOADSTOOL_SOIL.get(), ModBlocks.COARSE_TOADSTOOL_SOIL.get());
        ...
        tag(BlockTags.OVERWORLD_CARVER_REPLACEABLES).add(ModBlocks.GRITZY_SANDSTONE.get(), ModBlocks.VANILLATE.get());
    }
