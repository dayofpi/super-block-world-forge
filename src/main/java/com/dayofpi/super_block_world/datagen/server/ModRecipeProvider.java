...
public class ModRecipeProvider  extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> pWriter) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.TOOLS, ModItems.WARP_LINK.get()).pattern("X#X").define('X', ModItems.GREEN_STAR_BIT.get()).define('#', ModItems.SUBCON_THREAD.get()).unlockedBy("has_subcon_thread", has(ModItems.SUBCON_THREAD.get())).save(pWriter);
