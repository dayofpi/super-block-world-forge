...
public class ModBlockEntityTypes {
    ...
    public static final RegistryObject<BlockEntityType<ModBrushableBlockEntity>> BRUSHABLE_BLOCK = BLOCK_ENTITY_TYPES.register("brushable_block", () -> BlockEntityType.Builder.of(ModBrushableBlockEntity::new, ModBlocks.SUSPICIOUS_GRITZY_SAND.get()).build(null));
}
